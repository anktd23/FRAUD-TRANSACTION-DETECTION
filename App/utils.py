...
def standard_dev(lst):
    ...
    `=================================================================================
    input_params -> lst:list , user_id:str
...
def tran_lst(data,user_id):
    """
    This method returns list of transaction amount for single user
    `====================================================================================
    ...
    try:
        ...
        for tran in transaction:
            tran_amt.append(float(tran['transaction_amt']))
            tran_amt.sort(reverse =False)
        return tran_amt
    except Exception as e:
        raise e

def tran_lst_all(data):
    """
    This method returns list of transaction amount for all user
    `====================================================================================
    input_params -> data:dict
    ouput -> tran_amt_all:list
    =====================================================================================
    """
    try:
        tran_amt_all = []
        for values in data.values():
            ...
            tran_amt_all.extend(lst)
            tran_amt_all.sort(reverse =False)
        return tran_amt_all
    except Exception as e:
        raise e
